...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { city_id: @district.city_id, name: @district.name } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { city_id: @district.city_id, name: @district.name } }
