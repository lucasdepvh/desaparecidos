...
class StreetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create street" do
    assert_difference('Street.count') do
      post streets_url, params: { street: { district_id: @street.district_id, name: @street.name, type: @street.type, zipcode: @street.zipcode } }
    end
  ...
  test "should update street" do
    patch street_url(@street), params: { street: { district_id: @street.district_id, name: @street.name, type: @street.type, zipcode: @street.zipcode } }
