...
class RelationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post relations_url, params: { relation: { desapeared_id: @relation.desapeared_id, relative_id: @relation.relative_id, user_id: @relation.user_id } }
    end
  ...
  test "should update relation" do
    patch relation_url(@relation), params: { relation: { desapeared_id: @relation.desapeared_id, relative_id: @relation.relative_id, user_id: @relation.user_id } }
